...
$sql_get= mysqli_query($con,"select * from suppliers_profile WHERE email='$email'");
if($sql_get){
...
<div class="card" style="width: 18rem;padding:10px;float:left;margin-left:5%;margin-top:15px;">
  ...
  <div class="card-body">
    ...
    <a href="<?php echo 'http://localhost/Acessories/supplier_pages/edit_item.php?v='.$id;?>" class="btn btn-primary">Edit</a>
