...
<p>if you don't have supplier account plz  <a href = "../supplier_sign_up.html"> sign up </a></p>
</div>
...
$email = $_POST['t_email'];
$pass = $_POST['t_pass'];
$sql_get= "select * from suppliers where email='$email' and password='$pass'";
...
$sql_f = mysqli_query($con , "insert into bad_boy(email,req_time,ip_address,ip_local_address,ip_proxy) 
